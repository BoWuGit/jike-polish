...
async function validate() {
  ...
  if ((projectFile.match(/PRODUCT_NAME = "阅赏";/g) ?? []).length !== 2) {
    throw new Error("Safari container product name must be 阅赏 in both configurations.");
  }
